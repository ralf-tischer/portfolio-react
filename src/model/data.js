const PROJECTS = [
    ...
    {   id: 3, 
        ...
        project_url: "/project"	,
        status: "open",		
        links: [{"title": "GitHub", "type": "github", "url": "https://github.com/ralf-tischer/bgt"}, 
                {"title": "Demo (needs touchscreen)", "type": "linkedin", "url": "https://ralf-tischer.github.io/bgt/module1.html"},
    ...
    {   id: 4, 
        ...
        status: "open",		
        links: [],
        tags: ["vba", "cad", "refactoring", "office"] },
    {   id: 5, 
...
const TAGS = [
    { tag_short: "python", tag_long: "Programming language Python.", color_text: "white", color_bg: "#222" },
    { tag_short: "flask", tag_long: "A popular Python web framework.", color_text: "white", color_bg: "#222" },
    { tag_short: "sharepoint", tag_long: "Microsoft Sharepoint.", color_text: "white", color_bg: "#222" },
    { tag_short: "javascript", tag_long: "Web programming language Javascript.", color_text: "white", color_bg: "#222" },
    { tag_short: "html", tag_long: "Hypertext markup language.", color_text: "white", color_bg: "#222" },
    { tag_short: "vba", tag_long: "Microsoft Visual Basic for Applications.", color_text: "white", color_bg: "#222" },
    { tag_short: "markdown", tag_long: "Generic text format markdown, for example used in README.md.", color_text: "white", color_bg: "#222" },
